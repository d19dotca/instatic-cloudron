...
Supported package releases are the latest package version only. Before disclosure, identify whether the issue belongs to the Cloudron packaging, Instatic, Bun, or a base-image/system dependency.
